...
nombre_estudiante = st.sidebar.text_input("Nombre del estudiante", "Edwar Mosquera")
codigo_estacion = st.sidebar.text_input("Código de estación", "26")
fecha_desde = st.sidebar.date_input("Desde", pd.to_datetime("2026-08-24")).strftime("%Y-%m-%d")
